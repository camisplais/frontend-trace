...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      {
        path: 'pruebas-entrega',
        name: 'pruebas-entrega',
        component: () => import('@/views/pruebasEntrega/PruebaEntregaView.vue'),
        meta: { title: 'Pruebas Entrega', roles: [Role.ADUANAS] },
      },
      {
      ...
      },
      {
        path: 'pendientes',
        name: 'pendientes',
        component: () => import('@/views/embarques/EmbarquesPendientesView.vue'),
        meta: { title: 'Pendientes', roles: [Role.EMBARQUES] },
      },
      {
        path: 'solicitudes',
        name: 'solicitudes',
        component: () => import('@/views/solicitudes/SolicitudesCSView.vue'),
        meta: { title: 'Solicitudes', roles: [Role.COORD_STOCK] },
      },
